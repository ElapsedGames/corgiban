  ...
  return (
    <main id="main-content" className="page-shell">
      ...
      <p className="page-subtitle">
        <code className="break-all font-mono text-accent">{pathname}</code> does not exist.
      </p>
      <section className="route-card" aria-label="Return navigation">
        <p className="text-sm text-muted">You can navigate to one of these pages instead:</p>
